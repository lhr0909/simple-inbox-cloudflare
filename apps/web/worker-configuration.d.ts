/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03da4ca4e03f861be6b770465eaad28b)
...
interface __BaseEnv_Env {
	...
	API: Fetcher /* cloudflare-inbox-replacement-staging-api */ | Fetcher /* cloudflare-inbox-replacement-production-api */ | Fetcher /* cloudflare-inbox-replacement-local-api */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		APP_ORIGIN: "https://inbox-staging.example.test";
		ENVIRONMENT: "staging";
		API: Fetcher /* cloudflare-inbox-replacement-staging-api */;
	}
	interface ProductionEnv {
		APP_ORIGIN: "https://inbox.example.test";
		ENVIRONMENT: "production";
		API: Fetcher /* cloudflare-inbox-replacement-production-api */;
	}
