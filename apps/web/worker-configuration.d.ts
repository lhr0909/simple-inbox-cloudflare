/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8dc286a88721501de93c29953ffb1d86)
...
interface __BaseEnv_Env {
	...
	API: Fetcher /* simple-inbox-cf-staging-api */ | Fetcher /* simple-inbox-cf-production-api */ | Fetcher /* simple-inbox-cf-local-api */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		APP_ORIGIN: "https://inbox-staging.example.test";
		ENVIRONMENT: "staging";
		API: Fetcher /* simple-inbox-cf-staging-api */;
	}
	interface ProductionEnv {
		APP_ORIGIN: "https://inbox.example.test";
		ENVIRONMENT: "production";
		API: Fetcher /* simple-inbox-cf-production-api */;
	}
