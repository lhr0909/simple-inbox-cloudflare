/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0cb6adf0fa9b5bd9f210765e27e2a3d8)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 
interface __BaseEnv_CloudflareBindings {
	RAW_EMAILS: R2Bucket;
	DB: D1Database;
	AUTH_RATE_LIMIT: RateLimit;
	APP_ORIGIN: "https://inbox-staging.example.test" | "https://inbox.example.test" | "http://localhost:3000";
	MAIL_DOMAIN: "mail-staging.example.test" | "mail.example.test" | "example.test";
	OWNER_EMAIL: "owner@example.test";
	ENVIRONMENT: "staging" | "production" | "local";
	RAW_EMAIL_RETENTION_DAYS: "365";
	MAIL: Fetcher /* cloudflare-inbox-replacement-staging-mail */ | Fetcher /* cloudflare-inbox-replacement-production-mail */ | Fetcher /* cloudflare-inbox-replacement-local-mail */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		DB: D1Database;
		AUTH_RATE_LIMIT: RateLimit;
		APP_ORIGIN: "https://inbox-staging.example.test";
		MAIL_DOMAIN: "mail-staging.example.test";
		OWNER_EMAIL: "owner@example.test";
		ENVIRONMENT: "staging";
		RAW_EMAIL_RETENTION_DAYS: "365";
		MAIL: Fetcher /* cloudflare-inbox-replacement-staging-mail */;
	}
	interface ProductionEnv {
		...
		RAW_EMAIL_RETENTION_DAYS: "365";
		MAIL: Fetcher /* cloudflare-inbox-replacement-production-mail */;
	}
